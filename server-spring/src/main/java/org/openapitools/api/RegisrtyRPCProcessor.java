...
public class RegisrtyRPCProcessor {
    ...
    static <T> T invokeMethod(final Object parameter, final Class<T> returnClass) throws CouldNotPerformException {
        ...
        /*Method orig = null;
        for (Method method : RegistryApi.class.getMethods()) {
        ...
        System.out.println("RegistryClass: " + registry.getClass().getSimpleName());
        ...
        if (method.getParameters().length == 0) {
            try {
                Object invoke = method.invoke(registry);
                System.out.println("Convert return value from [" + invoke.getClass().getSimpleName() + "] to [" + returnClass.getSimpleName() + "]");
    ...
    public static Object convertParameter(final Object parameter, final Class<?> parameterClass, final Type genericType) throws CouldNotPerformException {
        if (Message.class.isAssignableFrom(parameterClass)) {
            ...
            if (!parameter.equals(String.class)) {
                throw new CouldNotPerformException("Unexpected parameter type[" + parameter.getClass().getSimpleName() + "] for enum. Should be a string.");
            }
            try {
                return parameterClass.getMethod("valueOf", String.class).invoke(null, parameterClass);
    ...
    public static <T> T convertReturnValue(final Object returnValue, final Class<T> returnClass) throws CouldNotPerformException {
        if (Message.class.isAssignableFrom(returnValue.getClass())) {
            System.out.println("Return value is a message");
            try {
