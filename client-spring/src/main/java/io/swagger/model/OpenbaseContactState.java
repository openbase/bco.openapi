...
import io.swagger.model.OpenbaseContactStateMapFieldEntry;
import io.swagger.model.OpenbaseContactStateState;
...
public class OpenbaseContactState   {
  ...
  @JsonProperty("value")
  private OpenbaseContactStateState value = null;
  ...
  public OpenbaseContactState addLastValueOccurrenceItem(OpenbaseContactStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbaseContactStateMapFieldEntry>();
    }
