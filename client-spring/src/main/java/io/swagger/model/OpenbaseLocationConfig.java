...
import io.swagger.model.OpenbaseLocationConfigLocationType;
import io.swagger.model.OpenbaseTileConfig;
...
public class OpenbaseLocationConfig   {
  ...
  private OpenbaseLocationConfigLocationType locationType = null;
  ...
  **/
  ...
  public OpenbaseLocationConfig addUnitIdItem(String unitIdItem) {
    if (this.unitId == null) {
      this.unitId = new ArrayList<String>();
    }
