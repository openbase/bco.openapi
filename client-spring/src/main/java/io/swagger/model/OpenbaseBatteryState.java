...
import io.swagger.model.OpenbaseBatteryStateMapFieldEntry;
import io.swagger.model.OpenbaseBatteryStateState;
...
public class OpenbaseBatteryState   {
  ...
  @JsonProperty("value")
  private OpenbaseBatteryStateState value = null;
  ...
  public OpenbaseBatteryState addLastValueOccurrenceItem(OpenbaseBatteryStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbaseBatteryStateMapFieldEntry>();
    }
