...
import io.swagger.model.OpenbaseInventoryStateMapFieldEntry;
...
public class OpenbaseInventoryState   {
  ...
  @JsonProperty("value")
  private OpenbaseInventoryStateState value = null;
  ...
  **/
  ...
  public OpenbaseInventoryState addLastValueOccurrenceItem(OpenbaseInventoryStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbaseInventoryStateMapFieldEntry>();
    }
