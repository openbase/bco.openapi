...
import io.swagger.model.OpenbaseUserTransitStateMapFieldEntry;
...
public class OpenbaseUserTransitState   {
  ...
  @JsonProperty("value")
  private OpenbaseUserTransitStateState value = null;
  ...
  public OpenbaseUserTransitState addLastValueOccurrenceItem(OpenbaseUserTransitStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbaseUserTransitStateMapFieldEntry>();
    }
