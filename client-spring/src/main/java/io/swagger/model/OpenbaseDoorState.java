...
import io.swagger.model.OpenbaseDoorStateMapFieldEntry;
...
public class OpenbaseDoorState   {
  ...
  @JsonProperty("value")
  private OpenbaseDoorStateState value = null;
  ...
  public OpenbaseDoorState addLastValueOccurrenceItem(OpenbaseDoorStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbaseDoorStateMapFieldEntry>();
    }
