...
import io.swagger.model.OpenbaseServiceCommunicationTypeCommunicationType;
...
public class OpenbaseServiceTemplate   {
  ...
  private OpenbaseServiceCommunicationTypeCommunicationType communicationType = null;
  ...
  **/
  ...
  public OpenbaseServiceTemplate addSuperTypeItem(OpenbaseServiceTemplateServiceType superTypeItem) {
    if (this.superType == null) {
      this.superType = new ArrayList<OpenbaseServiceTemplateServiceType>();
    }
