...
import io.swagger.model.OpenbaseWindowStateMapFieldEntry;
...
public class OpenbaseWindowState   {
  ...
  @JsonProperty("value")
  private OpenbaseWindowStateState value = null;
  ...
  public OpenbaseWindowState addLastValueOccurrenceItem(OpenbaseWindowStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbaseWindowStateMapFieldEntry>();
    }
