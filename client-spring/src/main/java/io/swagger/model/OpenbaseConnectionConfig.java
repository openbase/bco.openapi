...
import io.swagger.model.OpenbaseConnectionConfigConnectionType;
...
public class OpenbaseConnectionConfig   {
  ...
  private OpenbaseConnectionConfigConnectionType connectionType = null;
  ...
  **/
  ...
  public OpenbaseConnectionConfig addTileIdItem(String tileIdItem) {
    if (this.tileId == null) {
      this.tileId = new ArrayList<String>();
    }
