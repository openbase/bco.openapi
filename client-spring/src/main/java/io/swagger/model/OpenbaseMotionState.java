...
import io.swagger.model.OpenbaseMotionStateMapFieldEntry;
...
public class OpenbaseMotionState   {
  ...
  @JsonProperty("value")
  private OpenbaseMotionStateState value = null;
  ...
  public OpenbaseMotionState addLastValueOccurrenceItem(OpenbaseMotionStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbaseMotionStateMapFieldEntry>();
    }
