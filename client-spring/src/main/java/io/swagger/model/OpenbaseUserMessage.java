...
import io.swagger.model.OpenbaseUserMessageMessageType;
...
public class OpenbaseUserMessage   {
  ...
  private OpenbaseUserMessageMessageType messageType = null;
  ...
  **/
  ...
  public OpenbaseUserMessage addConditionItem(OpenbaseServiceStateDescription conditionItem) {
    if (this.condition == null) {
      this.condition = new ArrayList<OpenbaseServiceStateDescription>();
    }
