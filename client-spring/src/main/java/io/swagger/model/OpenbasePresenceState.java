...
import io.swagger.model.OpenbasePresenceStateMapFieldEntry;
...
public class OpenbasePresenceState   {
  ...
  @JsonProperty("value")
  private OpenbasePresenceStateState value = null;
  ...
  public OpenbasePresenceState addLastValueOccurrenceItem(OpenbasePresenceStateMapFieldEntry lastValueOccurrenceItem) {
    if (this.lastValueOccurrence == null) {
      this.lastValueOccurrence = new ArrayList<OpenbasePresenceStateMapFieldEntry>();
    }
