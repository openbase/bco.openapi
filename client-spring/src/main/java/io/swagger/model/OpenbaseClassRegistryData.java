...
import io.swagger.model.OpenbaseAgentClass;
import io.swagger.model.OpenbaseAppClass;
import io.swagger.model.OpenbaseDeviceClass;
...
public class OpenbaseClassRegistryData   {
  ...
  private Boolean agentClassRegistryConsistent = null;

  @JsonProperty("agent_class_registry_read_only")
  private Boolean agentClassRegistryReadOnly = null;
  ...
  private Boolean appClassRegistryConsistent = null;

  @JsonProperty("app_class_registry_read_only")
  private Boolean appClassRegistryReadOnly = null;
  ...
  private Boolean deviceClassRegistryConsistent = null;

  @JsonProperty("device_class_registry_read_only")
  private Boolean deviceClassRegistryReadOnly = null;
  ...
  public OpenbaseClassRegistryData addAgentClassItem(OpenbaseAgentClass agentClassItem) {
    if (this.agentClass == null) {
      this.agentClass = new ArrayList<OpenbaseAgentClass>();
    }
  ...
  **/
  ...
  public OpenbaseClassRegistryData addAppClassItem(OpenbaseAppClass appClassItem) {
    if (this.appClass == null) {
      this.appClass = new ArrayList<OpenbaseAppClass>();
    }
  ...
  **/
  ...
  public OpenbaseClassRegistryData addDeviceClassItem(OpenbaseDeviceClass deviceClassItem) {
    if (this.deviceClass == null) {
      this.deviceClass = new ArrayList<OpenbaseDeviceClass>();
    }
