...
import io.swagger.model.OpenbaseIlluminanceStateDataUnit;
...
public class OpenbaseIlluminanceState   {
  ...
  private Double illuminance = null;

  @JsonProperty("illuminance_data_unit")
  private OpenbaseIlluminanceStateDataUnit illuminanceDataUnit = null;
